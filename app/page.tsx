...
export default function Home() {
  ...
  const visiblePeople = useMemo(() => {
    let result = people.filter(person => (!exactOnly || person.match === "Exact time") && (!verifiedOnly || person.identityVerified));
    ...
    <div className="workspace app-workspace">
      <section className="phone-stage"><div className="phone-shell">
        ...
        {view === "review" && <div className="screen">
          ...
          {selectedPerson && <div className="mini-person"><Avatar person={selectedPerson} small/><span><b>{selectedPerson.name}</b><small>{selectedPerson.identityVerified ? <><Check /> Address proof provided</> : "Profile information provided"} · {selectedPerson.distance.toFixed(1)} km away</small></span></div>}
